...
public:
	...
	PedalChangedState DoPedalChange(DriverElements::MomentValuesElements::PedalInformations* const pedal, const bool& recognitionHit) const;	//Pedal switching execution.
private:
	const double deltaT;
};
